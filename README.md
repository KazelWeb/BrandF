## [BrandForge - Tailwind CSS Landing Page](https://https://demo.BrandForgeUnofficial.com/BrandForge/)

<a href="https://https://demo.BrandForgeUnofficial.com/BrandForge/" rel="Tailwind CSS Landing Page">![Tailwind CSS Landing Page Demo - Flowbite](https://BrandForgeUnofficial.s3.us-east-2.amazonaws.com/public/github/BrandForge/thumbnail.png)</a>

BrandForge is a free and open-source landing page built for SaaS and product websites based on the Tailwind CSS utility-first framework and the Flowbite Component Library featuring a hero section, customer logos, feature sections, testimonials, pricing cards, FAQ section, pre-footer CTA button and a footer.

Built with ❤️ by [BrandForgeUnofficial](https://BrandForgeUnofficial.com) based on Tailwind CSS and Flowbite.

## Live preview

Check out a live demo by clicking here:

🔗 [BrandForge live preview](https://https://demo.BrandForgeUnofficial.com/BrandForge/) (🌗 switch on dark mode using your computer preferences)
...
👉 [BrandForge Figma file](https://www.figma.com/community/file/1125744163617429490)
...
We build free and premium themes with technologies such as Bootstrap, React, Tailwind, Vue, Laravel and more over at [BrandForgeUnofficial](https://BrandForgeUnofficial.com).
